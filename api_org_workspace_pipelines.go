...
func (a *OrgWorkspacePipelinesService) CommandExecute(r OrgWorkspacePipelinesApiCommandRequest) (PipelineCommandResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgWorkspacePipelinesService.Command")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/org/{org_handle}/workspace/{workspace_handle}/pipeline/{pipeline_id}/command"
