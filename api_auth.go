...
func (r AuthApiLoginRequest) Request(request TypesUserLoginRequest) AuthApiLoginRequest {
	r.request = &request
	return r
}
...
func (r AuthApiSignupRequest) Request(request TypesUserSignupRequest) AuthApiSignupRequest {
	r.request = &request
	return r
}
