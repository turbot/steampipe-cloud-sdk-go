...
type UsersApiGetFeaturesRequest struct {
	ctx        _context.Context
	ApiService *UsersService
	userHandle string
}

func (r UsersApiGetFeaturesRequest) Execute() (Features, *_nethttp.Response, error) {
	return r.ApiService.GetFeaturesExecute(r)
}

/*
GetFeatures User features

Returns the feature information for a user.

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param userHandle Specify the user handle to get the feature details.
 @return UsersApiGetFeaturesRequest
*/
func (a *UsersService) GetFeatures(ctx _context.Context, userHandle string) UsersApiGetFeaturesRequest {
	return UsersApiGetFeaturesRequest{
		ApiService: a,
		ctx:        ctx,
		userHandle: userHandle,
...
// Execute executes the request
//  @return Features
func (a *UsersService) GetFeaturesExecute(r UsersApiGetFeaturesRequest) (Features, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersService.GetFeatures")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
