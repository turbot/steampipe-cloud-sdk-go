...
type OrgsApiGetFeaturesRequest struct {
	ctx        _context.Context
	ApiService *OrgsService
	orgHandle  string
}

func (r OrgsApiGetFeaturesRequest) Execute() (Features, *_nethttp.Response, error) {
	return r.ApiService.GetFeaturesExecute(r)
}

/*
GetFeatures Org features

Returns the feature information for an org.

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param orgHandle Specify the org handle to get the feature details.
 @return OrgsApiGetFeaturesRequest
*/
func (a *OrgsService) GetFeatures(ctx _context.Context, orgHandle string) OrgsApiGetFeaturesRequest {
	return OrgsApiGetFeaturesRequest{
		ApiService: a,
		ctx:        ctx,
		orgHandle:  orgHandle,
...
// Execute executes the request
//  @return Features
func (a *OrgsService) GetFeaturesExecute(r OrgsApiGetFeaturesRequest) (Features, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrgsService.GetFeatures")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r OrgsApiListWorkspaceAuditLogsRequest) Execute() (ListAuditLogsResponse, *_nethttp.Response, error) {
