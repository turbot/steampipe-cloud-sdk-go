...
func (o *WorkspaceConnection) GetConnectionLevel() string {
	...
	return o.ConnectionLevel
}

// GetConnectionLevelOk returns a tuple with the ConnectionLevel field value
// and a boolean to check if the value has been set.
func (o *WorkspaceConnection) GetConnectionLevelOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ConnectionLevel, true
}
...
func (o WorkspaceConnection) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["connection_level"] = o.ConnectionLevel
	}
	if true {
