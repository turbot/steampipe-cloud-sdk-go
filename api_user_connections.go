...
func (r ApiCreateUserConnectionRequest) Request(request TypesCreateConnectionRequest) ApiCreateUserConnectionRequest {
	r.request = &request
	return r
}

func (r ApiCreateUserConnectionRequest) Execute() (TypesConnection, *_nethttp.Response, error) {
...
/*
DeleteUserConnection Delete user connection
...
/*
GetUserConnection Get user connection
...
// Pagination limit
func (r ApiListActorConnectionsRequest) Limit(limit int32) ApiListActorConnectionsRequest {
	r.limit = &limit
	return r
}
...
func (r ApiListActorConnectionsRequest) Execute() (TypesListConnectionsResponse, *_nethttp.Response, error) {
	return r.ApiService.ListActorConnectionsExecute(r)
}

/*
ListActorConnections List actor connections
...
// Pagination limit
func (r ApiListUserConnectionsRequest) Limit(limit int32) ApiListUserConnectionsRequest {
	r.limit = &limit
	return r
}
...
func (r ApiListUserConnectionsRequest) Execute() (TypesListConnectionsResponse, *_nethttp.Response, error) {
...
func (r ApiUpdateUserConnectionRequest) Request(request TypesUpdateConnectionRequest) ApiUpdateUserConnectionRequest {
	r.request = &request
	return r
}

func (r ApiUpdateUserConnectionRequest) Execute() (TypesConnection, *_nethttp.Response, error) {
	return r.ApiService.UpdateUserConnectionExecute(r)
}

/*
UpdateUserConnection Update user connection
