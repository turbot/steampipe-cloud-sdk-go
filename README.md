...
*OrgWorkspaceModVariables* | [**Get**](docs/OrgWorkspaceModVariables.md#get) | **Get** /org/{org_handle}/workspace/{workspace_handle}/mod/{mod_alias}/variable/{variable_name} | Get variable for an organization workspace mod
...
*UserWorkspaceModVariables* | [**Get**](docs/UserWorkspaceModVariables.md#get) | **Get** /user/{user_handle}/workspace/{workspace_handle}/mod/{mod_alias}/variable/{variable_name} | Get variable for a user workspace mod
